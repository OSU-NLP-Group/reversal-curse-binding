...
class CausalLMOutputWithCrossAttentions(ModelOutput):
    ...
    loss: Optional[torch.FloatTensor] = None
    mrr: Optional[torch.FloatTensor] = None
    loss_wb: Optional[torch.FloatTensor] = None
    concept_loss: Optional[torch.FloatTensor] = None
    concept_mrr: Optional[torch.FloatTensor] = None
    concept_mse: Optional[torch.FloatTensor] = None
    logits: torch.FloatTensor = None
    past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = None
    hidden_states: Optional[Tuple[torch.FloatTensor, ...]] = None
    attentions: Optional[Tuple[torch.FloatTensor, ...]] = None
